...
import { EditCategorySchema, type EditCategoryData } from "schemas/Category/EditCategorySchema";

interface CategoryEditFormProps {
  initialData: EditCategoryData;
  onSubmit: (data: EditCategoryData) => void;
    ...
    >
      ...
      <div className="flex flex-col">
        ...
        <textarea
          ...
          rows={4}
          className={`${inputStyle(!!errors.description)} resize-none leading-relaxed`}
          placeholder="Ex: Categoria relacionada ao meio ambiente"
        />
