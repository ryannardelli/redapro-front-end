...
export const EmptyActivitiesStudent: React.FC<EmptyActivitiesProps> = ({ message }) => {
  return (
    <div className="flex flex-col items-center justify-center p-8 gap-4 text-center text-slate-600">
      ...
      <RouterLinks 
        href="/essay-upload" 
        className="mt-2 px-4 py-2 bg-purple-600 text-white rounded hover:bg-purple-700 transition cursor-pointer"
      >
        Criar Redação
      </RouterLinks>
    </div>
